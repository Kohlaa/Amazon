import 'package:chat/componants/product_row.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        height: MySizeConfig.safeBlockVerticalWithAppBar! * 73,
          ...
          child: Column(
            ...
            children: [
              Text(
                '$pListTitle',
                style:
                    const TextStyle(fontSize: 22, fontWeight: FontWeight.w100),
              ),
              Column(
                children: [
                  ProductRow(
